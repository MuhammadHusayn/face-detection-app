...
function styles(){
    ...
    remove_rows[4].style.height = '400px'
...
async function getUsers(){
    ...
    for (const i of data) {
        ...
        employerEdit.classList.add('btn', 'btn-sm', 'btn-white', 'text-success', 'me-2', 'user_update_btn')
        employerDelete.classList.add('btn', 'btn-sm', 'btn-white', 'text-danger', 'me-2', 'user_delete_btn')
        ...
        i.onclick = async (e) => {
            ...
            userSaveBtn.onclick = async (i) => {
                ...
                if (userIsadminSelect.value == '1' || userIsadminSelect.value == '2') {
                    ...
                    } else if (userIsadminSelect.value == '1') {
